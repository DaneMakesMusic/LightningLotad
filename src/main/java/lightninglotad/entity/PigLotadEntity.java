...
public class PigLotadEntity extends PathfinderMob {
	public PigLotadEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(LightninglotadModEntities.PIG_LOTAD.get(), world);
	}

	public PigLotadEntity(EntityType<PigLotadEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 3;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(LightninglotadModEntities.PIG_LOTAD.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
